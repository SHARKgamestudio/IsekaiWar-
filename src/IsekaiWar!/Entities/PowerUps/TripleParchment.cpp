...
#define TEXTURE Managers::GetInstance()->ResourceManager->GetTexture("tripleParchment")
#define COLUMNS 1
#define ROWS 1
#define RADIUS 30.f
#define ATTACK 2.f
...
TripleParchment::TripleParchment(float x, float y)
...
TripleParchment::TripleParchment(sf::Vector2f position)
